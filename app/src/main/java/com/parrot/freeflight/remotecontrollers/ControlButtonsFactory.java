...
//        result.setUpControllButton(ControlButtons.BUTTON_PITCH_LEFT, KeyEvent.KEYCODE_NUMPAD_0);
//        result.setUpControllButton(ControlButtons.BUTTON_PITCH_RIGHT, KeyEvent.KEYCODE_NUMPAD_1);
//        result.setUpControllButton(ControlButtons.BUTTON_ROLL_FORWARD, KeyEvent.KEYCODE_NUMPAD_2);
//        result.setUpControllButton(ControlButtons.BUTTON_ROLL_BACKWARD, KeyEvent.KEYCODE_NUMPAD_3);
